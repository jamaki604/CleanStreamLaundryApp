import 'package:clean_stream_laundry_app/features/maintenance_request/widgets/header.dart';
...
void main() {
  ...
  group('Header', () {
    ...
    testWidgets('displays Submit a Maintenance Request title', (tester) async {
      await tester.pumpWidget(buildWidget());
    ...
    testWidgets('title has bold font weight', (tester) async {
      await tester.pumpWidget(buildWidget());
      final text = tester.widget<Text>(find.text('Submit a Maintenance Request'));
