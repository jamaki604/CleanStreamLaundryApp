  ...
  group('LoyaltyPage Widget Tests', () {
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        expect(
          find.text('Enter load amount'),
          findsOneWidget,
          reason: 'The dialog should have the title "Enter load amount".',
        );
    ...
    testWidgets('Shows snackbar when invalid amount (zero) is entered', (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(createTestWidget());
      await tester.pumpAndSettle();
    ...
    testWidgets('Shows snackbar when negative amount is entered', (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(createTestWidget());
      await tester.pumpAndSettle();
    ...
    testWidgets('Shows snackbar when invalid text is entered', (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(createTestWidget());
      await tester.pumpAndSettle();
