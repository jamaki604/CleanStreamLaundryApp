...
void main() {
  ...
  group('PaymentPage Initialization', () {
    ...
    testWidgets('displays machine information after loading', (WidgetTester tester) async {
      when(() => mockAuthService.getCurrentUserId).thenReturn('user123');
      when(() => mockMachineService.getMachineById('machine123')).thenAnswer((_) async => {
        'Name': 'Washer01',
        'Price': 3.50,
      });
      when(() => mockProfileService.getUserBalanceById('user123')).thenAnswer((_) async => {
        'balance': 10.0,
      });
    ...
    testWidgets('handles machine not found error', (WidgetTester tester) async {
      when(() => mockAuthService.getCurrentUserId).thenReturn('user123');
      when(() => mockMachineService.getMachineById(any())).thenAnswer((_) async => null);
      when(() => mockProfileService.getUserBalanceById(any())).thenAnswer((_) async => {
        'balance': 10.0,
      });
  ...
  group('payment Buttons', () {
    ...
    testWidgets('disables loyalty button when balance is insufficient', (WidgetTester tester) async {
      when(() => mockAuthService.getCurrentUserId).thenReturn('user123');
      when(() => mockMachineService.getMachineById(any())).thenAnswer((_) async => {
        'Name': 'Washer01',
        'Price': 3.50,
    ...
    testWidgets('enables loyalty button when balance is sufficient', (WidgetTester tester) async {
      when(() => mockAuthService.getCurrentUserId).thenReturn('user123');
      when(() => mockMachineService.getMachineById(any())).thenAnswer((_) async => {
        'Name': 'Washer01',
        'Price': 3.50,
  ...
  group('Loyalty payment Processing', () {
    ...
    testWidgets('handles machine wake failure in loyalty payment', (WidgetTester tester) async {
      when(() => mockAuthService.getCurrentUserId).thenReturn('user123');
      when(() => mockMachineService.getMachineById(any())).thenAnswer((_) async => {
        'Name': 'Washer01',
        'Price': 3.50,
      ...
      when(() => mockProfileService.updateBalanceById(any())).thenAnswer((_) async => {});
      when(() => mockMachineCommunicator.wakeDevice(any())).thenAnswer((_) async => false);
